...
public class HttpServer{
	...
	public static void main(String[] args) throws IOException{
		...
		// Fixa numGuess så att det går att avgöra när en klient vinner.
		// Måste ha gissat för att kunna vinna...
		
		//Just nu är allt vad trådar heter utkommenterat.
		//Har introducerat numguess i funktionen setAnswer.
		
		/*
		 * Tror vi behöver lite mer struktur i koden :D
		 * Göra en funktion som vid anslutning och eventuellt
		 * cookie läser in värdena till variabler
		 * som vi sen kan använda, och det blir bara
		 * enklare med trådar.
		 * Då kan man använda dem variablerna för att göra
		 * allt typ. Just nu är ju den metoden som
		 * läser in kakan direkt sammanlänkad med att skapa den nya,
		 * och det är ju rätt synd eftersom vi gärna vill ha
		 * dessa värden när vi utvärderar gissningen, främst
		 * för att kolla så att det faktist var en gissning typ.
		 * 
		 * Satteh.. Varsågod, kompileringsfel ^^
		 */
	...
	private synchronized static String setAnswer(int low, int high, int numGuess, boolean tooHigh, boolean tooLow) {
	...
	private synchronized static String setCookie(String value, boolean low, boolean high, int guess) {
